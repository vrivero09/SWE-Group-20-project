        ...
        <Navbar className = "navbar navbar-dark bg-dark"color="dark" light expand="md">
          ...
          <Collapse isOpen={this.state.toggle} navbar>
            <Nav className="mr-auto" navbar>
              <NavItem>
                <NavLink tag = {RRNavLink}  to="/Books" activeClassName="active"><b>Books</b></NavLink>
              </NavItem>
            </Nav>
            
            <NavbarText className="test">
              <NavLink tag = {RRNavLink}  to="/Cart" activeClassName="active"><MaterialIcon icon="shopping_cart" size={25} />
              </NavLink>
            </NavbarText>
            <NavbarText>
              <NavLink tag = {RRNavLink}  to="/Wishlist" activeClassName="active"><MaterialIcon icon="assignment" size={25} /><Badge>{wishlistItemCount}</Badge></NavLink>
            </NavbarText>
            <Nav navbar>
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu right>
                  <DropdownItem tag = {RRNavLink} to="/Profile" activeClassName="active">
                    Profile
                  </DropdownItem>
