...
//contain all the interactions with the backend server, using the axios module

//fetches all the available products from the server.
export function getProducts() {
        return axios.get(`${BASE_URL}/api/products`)
        .then(response => response.data);
}

//fetches all the products in the cart by passing the cart string to the server.
